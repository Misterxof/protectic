...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id){
            case R.id.story:
                flag = true;
                i = new Intent(MainActivity.this, first_tab.class);
            ...
            case R.id.games1:
                ...
                startActivity(i);
                break;
            case R.id.materials1:
                flag = true;
                i = new Intent(MainActivity.this, second_tab.class);
                i.putExtra("fragment", 0);
                startActivity(i);
                break;
            case R.id.test2:
            ...
            case R.id.games2:
                ...
                startActivity(i);
                break;
            case R.id.materials2:
                flag = true;
                i = new Intent(MainActivity.this, third_tab.class);
                i.putExtra("fragment", 0);
                startActivity(i);
                break;
            case R.id.test3:
